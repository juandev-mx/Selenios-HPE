...
// Cargar equipos desde la API - OPTIMIZADO (GLOBAL)
...
// Cargar items de un equipo específico (GLOBAL)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Cargar datos usando las funciones globales
  loadEquipment();
  loadItems();
